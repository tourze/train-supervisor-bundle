...
[![PHP 版本](https://img.shields.io/badge/php-8.1%2B-blue.svg)](https://php.net)
[![Symfony 版本](https://img.shields.io/badge/symfony-6.4%2B-green.svg)](https://symfony.com)
[![许可证](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)
[![构建状态](https://img.shields.io/badge/build-passing-brightgreen.svg)]()
[![代码覆盖率](https://img.shields.io/badge/coverage-95%25-brightgreen.svg)]()
...
```bash
# 执行所有活跃的监督计划
php bin/console train:supervision:plan:execute

# 执行指定的监督计划
php bin/console train:supervision:plan:execute --plan-id=123

# 预览模式（不实际执行）
php bin/console train:supervision:plan:execute --dry-run
```
...
```bash
# 生成日报
php bin/console train:supervision:report daily

# 生成月报
php bin/console train:supervision:report monthly --date=2024-06-01

# 生成专项报告
php bin/console train:supervision:report special --start-date=2024-01-01 --end-date=2024-06-30 --title="专项监督报告"

# 自动发布报告
php bin/console train:supervision:report daily --auto-publish

# 导出报告到文件
php bin/console train:supervision:report monthly --export=/path/to/report.json
```
...
# 同时进行数据汇总
php bin/console train:supervision:daily-data --aggregate
```
...
# 评估指定时间段
php bin/console train:supervision:quality-assessment --start-date=2024-01-01 --end-date=2024-06-30
```
...
# 检测指定时间段的异常
php bin/console train:supervision:anomaly-detection --start-date=2024-01-01 --end-date=2024-06-30
```
