 ...
 * @internal
 */
#[CoversClass(SupervisionInspection::class)]
final class SupervisionInspectionTest extends AbstractEntityTestCase
{
    protected function createEntity(): object
    {
        return new SupervisionInspection();
    }
    ...
    public static function propertiesProvider(): iterable
    {
        return [
            ...
            'inspectionType' => ['inspectionType', 'test_value'],
            'inspector' => ['inspector', 'test_value'],
            'inspectionItems' => ['inspectionItems', ['key' => 'value']],
            'inspectionResults' => ['inspectionResults', ['key' => 'value']],
            'foundProblems' => ['foundProblems', ['key' => 'value']],
            'inspectionStatus' => ['inspectionStatus', 'test_value'],
        ];
    }
     ...
     * 测试基本属性的获取和设置.
     */
    public function testAdditionalGettersAndSetters(): void
    {
