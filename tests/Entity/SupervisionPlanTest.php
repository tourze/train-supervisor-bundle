 ...
 * @internal
 */
#[CoversClass(SupervisionPlan::class)]
final class SupervisionPlanTest extends AbstractEntityTestCase
{
    protected function createEntity(): object
    {
        return new SupervisionPlan();
    }

    public static function propertiesProvider(): iterable
    {
        return [
            'planName' => ['planName', 'test_value'],
            'planType' => ['planType', 'test_value'],
            'supervisionScope' => ['supervisionScope', ['key' => 'value']],
            'supervisionItems' => ['supervisionItems', ['key' => 'value']],
            'supervisor' => ['supervisor', 'test_value'],
            'planStatus' => ['planStatus', 'test_value'],
        ];
    }
