 ...
 * 质量评估CRUD控制器.
 *
 * @extends AbstractCrudController<QualityAssessment>
 */
#[AdminCrud(routePath: '/train-supervisor/quality-assessment', routeName: 'train_supervisor_quality_assessment')]
final class QualityAssessmentCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            TextField::new('targetId', '目标ID')->setRequired(true),
            TextField::new('targetName', '评估对象名称')->setRequired(true),
            ChoiceField::new('assessmentType', '评估类型')
                ...
                ->setRequired(true),
            TextField::new('assessmentCriteria', '评估标准')->setRequired(true),
            ...
            TextField::new('assessmentLevel', '评估等级')->setRequired(true),
